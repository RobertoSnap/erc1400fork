    ...
    ERC1820Implementer
{
    ...
    bytes4 internal constant ERC20_TRANSFER_FUNCTION_ID = bytes4(
        keccak256("transfer(address,uint256)")
    );
    bytes4 internal constant ERC20_TRANSFERFROM_FUNCTION_ID = bytes4(
   ...
   */
    function _functionRequiresValidation(bytes4 functionSig)
        internal
        pure
        returns (bool)
    {
        if (
            areEqual(functionSig, ERC20_TRANSFER_FUNCTION_ID) ||
