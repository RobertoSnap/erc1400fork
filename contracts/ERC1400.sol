...
contract ERC1400 is IERC1400, ERC1400Partition, MinterRole {
   ...
   */
    function issueByPartition(
        ...
        uint256 value,
        bytes calldata data
    ) external onlyMinter issuableToken isValidCertificate(data) {
   ...
   */
    function setCertificateSigner(address operator, bool authorized)
        external
        onlyOwner
    {
   ...
   */
    function setCertificateControllerActivated(bool activated)
        external
        onlyOwner
    {
